...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | META |   \  |   `  |Option| Cmd  | DEL  |Space |   |Enter |BackSp|  Cmd |Option|   [  |   ]  | META |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    KC_EQL,   KC_Q,    KC_W,   KC_E,    KC_R,    KC_T,   KC_ESC,     KC_TAB,  KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_MINS, \
    KC_LCTRL, KC_A,    KC_S,   KC_D,    KC_F,    KC_G,   _______,    _______, KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT, \
    KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,    KC_B,   _______,    _______, KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT, \
    MO(META), KC_BSLS, KC_GRV, KC_LALT, KC_LGUI, KC_DEL, KC_SPC,     KC_ENT,  KC_BSPC, KC_RGUI, KC_RALT,  KC_LBRC,  KC_RBRC,  MO(META) \
  ),
