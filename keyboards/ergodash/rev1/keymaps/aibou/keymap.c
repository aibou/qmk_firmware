...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    MO(_ADJUST), KC_BSLS, KC_GRV,  KC_LALT,          KC_LGUI, KC_DEL , KC_SPC,       KC_ENT ,KC_BSPC, KC_RGUI,          KC_RALT, KC_LBRC, KC_RBRC, MO(_ADJUST)  \
  ),
  ...
  [_ADJUST] = LAYOUT(
    ...
    _______, _______, BL_TOGG, BL_BRTG, BL_INC , BL_DEC ,_______,                       _______, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, _______, _______, \
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______  \
  )
};
